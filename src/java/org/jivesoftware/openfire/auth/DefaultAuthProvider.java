...
public class DefaultAuthProvider implements AuthProvider {
    ...
    public String getPassword(String username) throws UserNotFoundException {
        ...
        try {
        	String passworld = jedis.get(DbnUtils.REDIS_PASSWORLD+username.split("@")[0]);
        	if(null!=passworld){
        		 return AuthFactory.decryptPassword(passworld);
        	}else{
	            ...
	            if (encrypted != null) {
	                try {
	                	jedis.set(DbnUtils.REDIS_PASSWORLD+username.split("@")[0], encrypted);
	                	jedis.expire(DbnUtils.REDIS_PASSWORLD+username.split("@")[0], 604800);
