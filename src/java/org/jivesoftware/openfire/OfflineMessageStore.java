...
import org.jivesoftware.openfire.dbn.dbnUtils.GenerateIdUtils;
...
public class OfflineMessageStore extends BasicModule implements UserEventListener {
    ...
    private static final String LOAD_OFFLINE =
        "SELECT stanza, creationDate FROM ofOffline WHERE username=? ORDER BY  creationDate desc LIMIT 500";
...
//        long messageID = SequenceManager.nextID(JiveConstants.OFFLINE);
        String messageID = GenerateIdUtils.generateUUID();
    ...
    public Collection<OfflineMessage> getMessages(String username, boolean delete) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (!message.toString().contains("delay")) {
